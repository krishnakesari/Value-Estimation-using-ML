...
# %%
# Selecting feature labels from data set
...
# %%
# Loading train model created
model = joblib.load('trained_house_classifier_model.pkl')


# %%
# Creating a numpy array based on the model's feature importances
importance = model.feature_importances_


# %%
# Sort the feature labels based on the feature importance rankings from the model
feature_indexes_by_imporatance = importance.argsort()


# %%
# Print each feature label, from most imporant to least important (reverse order)
for index in feature_indexes_by_imporatance:
